...
export default class BrandList extends Component{
	render(){
		return(
			<div className="materInner">
					<div className="materItem">
						<img src="http://www.fanjiangdz.com//weixin/newpublic/images/wxmater02.jpg"/>
					...
					<div className="materItem">
						<img src="http://www.fanjiangdz.com///weixin/newpublic/images/wxmater03.jpg"/>
						<div className="description">
							<h3>CERRUTI 1881</h3>
							<p>
							...
							<img src="http://www.fanjiangdz.com///weixin/newpublic/images/wxmater04.jpg"/>
						</div>
					</div>
					<div className="materItem">
						<img src="http://www.fanjiangdz.com//weixin/newpublic/images/wxmater06.jpg"/>
						<div className="description">
							<h3>CERRUTI 1881</h3>
							<p>
					...
					<div className="materItem">
						<img src="http://www.fanjiangdz.com//weixin/newpublic/images/wxmater07.png"/>
						<div className="description">
							<h3>CERRUTI 1881</h3>
							<p>
					...
					<div className="QRCode">
						<div className="QRPic">
						<img src="http://www.fanjiangdz.com//weixin/newpublic/images/fjerweima.jpg"/>
						</div>
						<div className="form">
							<p>长按识别图中的二维码</p>
							<p>关注"凡匠定制"微信公众号</p>
